...
export const dictionary = {
  es: {
    ...
    hero: {
      ...
      facts: [
        { value: "86 €", label: "por MWh ahorrado", sub: "tarifa CAES vigente" },
    ...
    ganancias: {
      ...
      results: {
        ...
        headYearSub: "{n} expedientes al año",
        headBacklog: "Lo que llevas sin cobrar desde 2024",
        headBacklogSub: "{n} expedientes de 2024, 2025 y 2026",
        chain: "Certificado {cert} · tu {pct} = {each} por expediente · × {n} instalaciones",
        oneOff: "Una sola vez",
        recurring: "Cada año, a partir de ahora",
        forQuote: "Y en cada presupuesto que hagas",
        perProject: "Por cada expediente",
        perYear: "Suma al año",
        backlog: "Los tres años atrasados",
        backlogSub: "{n} expedientes sin reclamar",
        client: "Lo que se lleva tu cliente",
        clientSub: "la cifra que puedes decirle antes de firmar",
        hours: "Horas de papeleo",
        perHour: "Lo que vale una hora de ese trabajo",
        split: "{backlog} de atrasado + {year} del año en curso",
        certValue: "Valor del certificado",
        certSub: "{kwh} kWh ahorrados al año, a 86 €/MWh",
        yearSub: "{each} por expediente · {h} h de papeleo · {hour} por hora",
        windowChip: "3 años recuperables · lo de 2024 caduca en 2027",
      },
      belowMin:
        "Con este perfil la instalación no llega al 20 % de ahorro mínimo. Sube la potencia o cambia el equipo sustituido.",
      disclaimer:
        "Estimación sobre la tarifa vigente de 86 €/MWh. El valor real se calcula sobre las facturas durante la revisión.",
  ...
  en: {
    ...
    hero: {
      ...
      facts: [
        { value: "€86", label: "per MWh saved", sub: "official rate" },
    ...
    ganancias: {
      ...
      results: {
        ...
        headYearSub: "{n} cases a year",
        headBacklog: "Unclaimed since 2024",
        headBacklogSub: "{n} cases from 2024, 2025 and 2026",
        chain: "Certificate {cert} · your {pct} = {each} per case · × {n} installations",
        oneOff: "One time only",
        recurring: "Every year from now on",
        forQuote: "And in every quote you write",
        perProject: "Per case",
        perYear: "Total per year",
        backlog: "The three years behind you",
        backlogSub: "{n} unclaimed cases",
        client: "What your customer gets",
        clientSub: "the figure you can give them before signing",
        hours: "Hours of paperwork",
        perHour: "What an hour of that work is worth",
        split: "{backlog} backlog + {year} from this year",
        certValue: "Certificate value",
        certSub: "{kwh} kWh saved per year, at 86 €/MWh",
        yearSub: "{each} per case · {h} h of paperwork · {hour} per hour",
        windowChip: "3 years recoverable · 2024 expires in 2027",
      },
      belowMin:
        "With this profile the installation does not reach the 20 % minimum saving. Raise the power or change the replaced system.",
      disclaimer:
        "Estimate based on the current 86 €/MWh tariff. The real value is calculated from the invoices during review.",
