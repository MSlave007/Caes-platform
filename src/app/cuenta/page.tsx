...
import { AlertCircle, ArrowLeft, Check, Camera, Loader2, Trash2 } from 'lucide-react'
...
export default function CuentaPage() {
    ...
    const volver = c.role === 'admin' ? '/admin/dashboard' : '/installer/dashboard'

    return (
        <div className="min-h-screen bg-[var(--caes-paper)] px-6 py-12 font-sans sm:px-10">
            <div className="mx-auto w-full max-w-[46rem]">
                ...
                <p className="label-mono mt-8 text-[var(--caes-mut)]">Tu cuenta</p>
